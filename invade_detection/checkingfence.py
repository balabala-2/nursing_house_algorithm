...
ap.add_argument("-f", "--filename", required=False, default = '/Users/userli/PycharmProjects/algorithm/invade_detection/tests/yard_01.mp4', help="")
args = vars(ap.parse_args())

# 全局变量
prototxt_file_path='models/MobileNetSSD_deploy.prototxt'
model_file_path='models/MobileNetSSD_deploy.caffemodel' 
output_fence_path = 'supervision/fence'
input_video = args['filename']
skip_frames = 30 # of skip frames between detections
# your python path
python_path = '/Users/userli/miniforge3/envs/algorithm/bin/python3.9' 
